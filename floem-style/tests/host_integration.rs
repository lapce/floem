...
fn sink_apply_animations_hook_is_invoked() {
    ...
    impl StyleSink for AnimHost {
        ...
        fn mark_descendants_with_selector_dirty(
            ...
            self.inner
                .mark_descendants_with_selector_dirty(ancestor, selector)
        }
        fn mark_descendants_with_responsive_selector_dirty(&mut self, ancestor: ElementId) {
            self.inner
                .mark_descendants_with_responsive_selector_dirty(ancestor)
        }
        fn update_selector_interest(
            ...
            self.inner.update_selector_interest(id, selectors)
        }
