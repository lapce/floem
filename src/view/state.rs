...
prop_extractor! {
    pub(crate) ViewStyleProps {
        ...
        pub background_brush_transform: crate::style::BackgroundBrushTransform,
        pub background_brush_rotation: crate::style::BackgroundBrushRotation,
        pub background_brush_scale_x: crate::style::BackgroundBrushScaleX,
        pub background_brush_scale_y: crate::style::BackgroundBrushScaleY,
