...
define_styles!(
    ...
    inset_left: LengthPercentageAuto = LengthPercentageAuto::ZERO,
    inset_top: LengthPercentageAuto = LengthPercentageAuto::ZERO,
    inset_right: LengthPercentageAuto = LengthPercentageAuto::ZERO,
    inset_bottom: LengthPercentageAuto = LengthPercentageAuto::ZERO,
