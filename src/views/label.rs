...
use crate::{
    ...
    style::{
        ...
        SelectionCornerRadius, SelectionStyle, Style, TextAlignProp, TextBrushTransform, TextColor,
...
impl View for Label {
    ...
    fn paint(&mut self, cx: &mut crate::context::PaintCx) {
        ...
        let text_brush_transform = Some(self.label_props.text_brush_transform());
