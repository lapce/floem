use std::{any::Any, collections::HashMap, ops::RangeInclusive, rc::Rc};
...
impl View for EditorView {
    ...
    // fn taffy_layout(&mut self, cx: &mut BoxLayoutCx) -> crate::taffy::tree::NodeId {
...
pub fn editor_view(
    ...
    .on_event_cont(EventListener::FocusGained, move |_, _| {
        focused.set(true);
